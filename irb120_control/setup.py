...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/urdf', glob('urdf/*.xacro') + glob('urdf/*.stl')),
        ('share/' + package_name + '/urdf/sensor_and_adapter_assembly',
            glob('urdf/sensor_and_adapter_assembly/*.urdf')),
        ('share/' + package_name + '/urdf/sensor_and_adapter_assembly/meshes',
            glob('urdf/sensor_and_adapter_assembly/meshes/*')),
